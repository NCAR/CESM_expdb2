#!/usr/bin/env python
"""
Insert the CMIP6 exps and requesting MIPs into the t2j_cmip6 table for 2deg and 2deg-waccm
Make sure the t2_cmip6_DECK_exps.sql table is up to date
--------------------------
...
def join_DECK_exps(db, cursor, version):
    ...
    deck_exps = { 'abrupt-4xCO2' : ['4xCO2-CESM2-BGC-2deg','4xCO2-CESM2-2deg-WACCM'],
                  '1pctCO2'      : ['1pctCO2-CESM2-BGC-2deg','1pctCO2-CESM2-2deg-WACCM'],
                  'amip'         : ['AMIP-CESM2-BGC-2deg','AMIP-CESM2-2deg-WACCM'] }
