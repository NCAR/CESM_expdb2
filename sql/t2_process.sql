...
values ('case_run','model run'),
       ...
       ('timeseries', 'single variable timeseries'),
       ...
       ('publish_esg', 'to ESG publication'),
       ('publish_dset', 'to DSET publication'),
       ('iconform', 'initialize conform variables'),
       ('atm_timeseries', 'atmosphere timeseries'),
       ('glc_timeseries', 'land-ice timeseries'),
